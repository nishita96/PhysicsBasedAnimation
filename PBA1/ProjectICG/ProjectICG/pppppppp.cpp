...
//cy::Vec3f lightDirV(30.0, 40.0, -35.0);
//std::string rootDir;
...
//}
//
//static void createVertexBufferForTeapot(cy::TriMesh *mesh){ //i kept OG
...
////        cy::Matrix4f viewMatrix1 = cy::Matrix4f::View(pos.XYZ() , trans.XYZ(), up.XYZ());
...
//        //cy::Matrix4f transformationMatrix = projMatrix * viewMatrix ;
...
//        
//        cy::Vec3f lightTrans(-yLightRot,13.0,-xLightRot);
////        cy::Vec3f lightTrans(20,13.0,20);
//        cy::Matrix4f translationLightMatrix = cy::Matrix4f::Translation(lightTrans.XYZ());
//        cy::Vec4f rotLightDir = viewMatrix * translationLightMatrix * lightDirV;//used for light dir
//        cy::Vec4f rotLightDir1 =  translationLightMatrix * lightDirV;
//        cy::Matrix4f lightMatrix = cy::Matrix4f::View(rotLightDir1.XYZ() , trans.XYZ(), up.XYZ());//view mat at light
////        cy::Matrix4f translationMatrix = projMatrix * viewMatrix * cy::Matrix4f::Scale(0.1) * translationLightMatrix;//for light obj
//        cy::Matrix4f matrixMLP = projMatrix * lightMatrix * cy::Matrix4f::Scale(1.0);
...
//        shadowMap.SetTextureWrappingMode( GL_CLAMP, GL_CLAMP );//not in prof
//        shadowMap.Bind();
//        
...
////        GLint modelMatrix_pos = glGetUniformLocation(prog.GetID(), "modelMatrix");//not needed
...
//        
////        GLint cameraPos = glGetUniformLocation(prog.GetID(), "cameraPos");//dont need
...
//        
////        glBindBuffer(GL_ARRAY_BUFFER, txc_t);
////        GLuint txc_t_location = glGetAttribLocation(prog.GetID(), "txc");
////        glEnableVertexAttribArray(txc_t_location);
////        glVertexAttribPointer(txc_t_location, 3, GL_FLOAT, GL_FALSE,
////                              0, (void*) 0);
//        glEnable(GL_DEPTH_TEST);//
//        glUseProgram(prog.GetID());
//        glActiveTexture(GL_TEXTURE0);
